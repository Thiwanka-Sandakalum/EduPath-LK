...
export const studentLoans: StudentLoan[] = [
  {
    id: 'boc-edu',
    name: 'BOC Educational Loan',
    provider: 'Bank of Ceylon',
    interestRate: '8.5% p.a. (fixed)',
    maxAmount: 'LKR 2,500,000',
    duration: 'Up to 7 years',
    eligibility: ['Sri Lankan citizen', 'Admission letter from recognized institution', 'Guarantor required'],
    features: ['Grace period up to 1 year', 'Flexible repayment', 'No early settlement fee'],
    applyLink: 'https://www.boc.lk/index.php?route=product/product&product_id=1234'
  },
  {
    id: 'peoples-edu',
    name: 'People’s Bank Student Loan',
    provider: 'People’s Bank',
    interestRate: '9.0% p.a. (variable)',
    maxAmount: 'LKR 1,800,000',
    duration: 'Up to 6 years',
    eligibility: ['Sri Lankan citizen', 'A/L or equivalent', 'Co-borrower required'],
    features: ['Quick approval', 'Insurance cover', 'Online application'],
    applyLink: 'https://www.peoplesbank.lk/student-loan/'
  },
  {
    id: 'hnb-edu',
    name: 'HNB Shakthi Education Loan',
    provider: 'Hatton National Bank',
    interestRate: '9.5% p.a. (variable)',
    maxAmount: 'LKR 2,000,000',
    duration: 'Up to 8 years',
    eligibility: ['Sri Lankan citizen', '18-55 years', 'Proof of admission'],
    features: ['Flexible collateral', 'Top-up facility', 'Special rates for merit students'],
    applyLink: 'https://www.hnb.net/personal/loans/education-loans'
  }
];
